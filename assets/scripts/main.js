...
async function getRecipes() {
    ...
    let localRecipe = localStorage.getItem('recipies');
    if (localRecipe) {
    ...
    return new Promise(async (resolve, rejeect) => {
        ...
        for (let url of RECIPE_URLS) {
            ...
            try {
                ...
                //            resolve() method.
                if (onlineRecipe.length === RECIPE_URLS.length) {
                    localStorage.setItem('recipes', JSON.stringify(onlineRecipe));
                    resolve(onlineRecipe);
                }
            } catch (errors) {
